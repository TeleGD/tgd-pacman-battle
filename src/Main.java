	...
	public static final void main(String[] arguments) {
		...
		new AppGame(title, width, height, fullscreen) {
			...
			public void init() {
				...
				this.addState(new pages.Pause(AppGame.PAGES_PAUSE)); this.addState(new games.pacmanBattle.World(AppGame.GAMES_PACMAN_BATTLE_WORLD));
			}
